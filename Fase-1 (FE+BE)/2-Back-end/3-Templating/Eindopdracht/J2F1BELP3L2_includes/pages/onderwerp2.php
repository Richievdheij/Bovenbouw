<?php 
$title2 = "COD";
$description2 = "Call of Duty: Modern Warfare 2 is een first-person shooter-videogame die in 2009 is ontwikkeld door Infinity Ward en uitgegeven door Activision. Het is het zesde deel in de Call of Duty-serie en de opvolger van Call of Duty 4: Modern Warfare.
...
$image2 = "Bovenbouw\Fase-1 (FE+BE)\2-Back-end\3-Templating\Eindopdracht\J2F1BELP3L2_includes\images\codpic.jpg";
?>
...
<body>
    ...
    <div>
      <img src="<?php echo $image2; ?>" alt="COD>
    </div>
</body>
</html>